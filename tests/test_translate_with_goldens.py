...
@pytest.mark.parametrize(
    "case_id",
    [*(f"C{n:03d}" for n in range(19, 27)), "C033", "C034", "C035", "C036", "C069"],
)
def test_translate_with_cases_match_goldens(corpus_cases, case_id: str):
    ...
    assert case.expected_aql is not None, "Golden AQL must be filled for WITH cases"
