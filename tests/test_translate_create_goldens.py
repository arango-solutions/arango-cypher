...
@pytest.mark.parametrize(
    "case_id",
    [f"C{n}" for n in range(260, 270)],
)
def test_translate_create_goldens(corpus_cases, case_id: str):
    ...
    assert case.expected_aql is not None, "Golden AQL must be filled for CREATE cases"
