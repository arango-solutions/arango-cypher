...
class TestVector:
    def test_cosine_similarity(self, registry, pg):
        out = translate(
            ...
            mapping=pg, registry=registry, params={"q": [0.1, 0.2]},
        )
...
class TestGeo:
    ...
    def test_geo_distance(self, registry, pg):
        out = translate(
            ...
            mapping=pg, registry=registry, params={"target": {"type": "Point", "coordinates": [0, 0]}},
        )
    ...
    def test_geo_intersects(self, registry, pg):
        out = translate(
            ...
            mapping=pg, registry=registry, params={"region": {}},
        )
    ...
    def test_geo_in_range(self, registry, pg):
        out = translate(
            ...
            mapping=pg, registry=registry, params={"center": {}},
        )
