...
Status: **Draft — Phase 1 (MT-0 / MT-1 / MT-5) shipped in Wave 7; Phase 2 (MT-2 / MT-3a / MT-4) shipped in Wave 8 (2026-05-27, PR #30); MT-3b (Layer 3 service-route wiring) + MT-6 (Layer 5 plan-shape LRU) shipped 2026-07-05.** Phase 3 MT-7 (admin bypass + audit stream) remains. Standalone document; to be merged into `python_prd.md` — see §Merge notes.
